...
function App() {
    ...
    function handleInput() {
        console.log("hanldeInput is called");
    ...
    return (
        <>
            <input id="wordleGuessInputBox" ref={inputRef} onChange={handleInput} onSubmit={handleAnswer} type="text" />
